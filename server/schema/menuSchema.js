...
function createDefaultMenu() {
  Menu.find({}).exec(function(err, collection) {
    if (collection.length === 0) {
      ...
      Menu.create({memberOfMenu: 'topMain', id: 3, parentId: 0, active: 1, icon:'fa fa-cogs', title:'Demo', position: 3, extUrl: '', target: '', link: "['Demo']", roles: [], alignment: 'Left', hasChildren: 0});
